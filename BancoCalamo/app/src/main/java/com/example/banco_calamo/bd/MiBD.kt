...
protected constructor(context: Context?) :
    ...
    private fun insercionDatos(db: SQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO movimientos (rowid, id, tipo, fechaoperacion, descripcion, importe, idcuentaorigen, idcuentadestino) VALUES (null, null, 1, 1423263780000, 'Ingreso Nómina Ayuntamiento Valencia Enero 2015', 2150.5, 4, 1);")
    }
